...
import { MON_PARAM, HEAD_PARAM } from '../JS/headParam';
...
export function PoketMonShop2() {
    ...
    const handleAllClick = () => {
        navigate("/", { state: { typeName: typeName } });
    }
    ...
    if (searchValue == null || searchValue == '') {
                ...
                <div className="pokemons-container" key={no}>
                    {
                        poketMonList.map((list, idx) => {
                            return (list.typeName != MON_PARAM.typeName) ? <></> :
        ...
        const poketMonItem = MON_PARAM.poketMonItem;
