...
import { MON_PARAM } from '../JS/headParam';
...
export function PoketMonShop() {
    ...
    const handleSearchClick = () => {
        ...
        MON_PARAM.poketMonItem = poketMonItem;
        MON_PARAM.serachType = searchValue;

        dispatch({ type: MON_PARAM, poketMonItem: poketMonItem, serachType: searchValue.current.value });
        navigate("/PoketMonShop2", { state: { poketMonItem: MON_PARAM.poketMonItem, searchValue: searchValue.current.value } });   
    }
